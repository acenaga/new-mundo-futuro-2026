<footer class="mt-20 border-t transition-colors duration-300"
        ...
        <div class="flex flex-col items-start justify-between gap-8 md:flex-row md:items-center">
            ...
            <div class="flex flex-col gap-3">
                <a href="{{ route('home') }}" class="flex items-center gap-3">
                    <img :src="isDark ? '{{ asset('assets/img/logo-dark.svg') }}' : '{{ asset('assets/img/logo.svg') }}'" alt="Mundo Futuro" class="h-8 w-auto">
